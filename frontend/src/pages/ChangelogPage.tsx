              ...
              <VStack align="stretch" spacing={4}>
                ...
                <List spacing={3} pl={2}>
                  <ListItem>
                    ...
                    Migramos toda a API para os Cloudflare Workers! Isso
                    significa que o site está mais rápido do que nunca e o
                    servidor não "dorme" mais.
                  </ListItem>
                  <ListItem>
                    <ListIcon as={CheckCircleIcon} color="green.500" />
                    <Text as="span" fontWeight="bold">
                    ...
                    Acompanhando a modernização do backend, o banco de dados
                    agora roda em uma infraestrutura serverless otimizada.
                  </ListItem>
                </List>
                ...
                <List spacing={3} pl={2}>
                  ...
                  <ListItem>
                    ...
                    Agora você pode clicar em qualquer livro da sua lista para
                    ver seus detalhes em um modal.
                  </ListItem>
                  <ListItem>
                    <ListIcon as={StarIcon} color="yellow.400" />
                    <Text as="span" fontWeight="bold">
